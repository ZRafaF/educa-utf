...
export enum Collections {
	Articles = 'articles',
	ArticlesPrivate = 'articles_private',
	ArticlesStats = 'articles_stats',
	Chapters = 'chapters',
	ChaptersPrivate = 'chapters_private',
...
export enum ArticlesPrivateVisibilityOptions {
	'public' = 'public',
	'private' = 'private',
}
export type ArticlesPrivateRecord = {
	...
	user: RecordIdString;
	views?: number;
	visibility: ArticlesPrivateVisibilityOptions;
};
...
export enum ChaptersPrivateVisibilityOptions {
	'public' = 'public',
	'private' = 'private',
}
export type ChaptersPrivateRecord = {
	articles?: RecordIdString[];
	author_avatar?: string;
	author_name: string;
	author_username?: string;
	...
	user?: RecordIdString;
	views?: number;
	visibility: ChaptersPrivateVisibilityOptions;
};
...
export type ArticlesPrivateResponse<Texpand = unknown> =
	Required<ArticlesPrivateRecord> & BaseSystemFields<Texpand>;
export type ArticlesStatsResponse<Texpand = unknown> =
	Required<ArticlesStatsRecord> & BaseSystemFields<Texpand>;
export type ChaptersResponse<Texpand = unknown> = Required<ChaptersRecord> &
	BaseSystemFields<Texpand>;
export type ChaptersPrivateResponse<Texpand = unknown> =
	Required<ChaptersPrivateRecord> & BaseSystemFields<Texpand>;
export type ChaptersStatsResponse<Texpand = unknown> =
	Required<ChaptersStatsRecord> & BaseSystemFields<Texpand>;
...
export type UsersStatsResponse<Texpand = unknown> = Required<UsersStatsRecord> &
	BaseSystemFields<Texpand>;
...
export type CollectionRecords = {
	...
	articles_private: ArticlesPrivateRecord;
	articles_stats: ArticlesStatsRecord;
	chapters: ChaptersRecord;
	chapters_private: ChaptersPrivateRecord;
...
export type CollectionResponses = {
	...
	articles_private: ArticlesPrivateResponse;
	articles_stats: ArticlesStatsResponse;
	chapters: ChaptersResponse;
	chapters_private: ChaptersPrivateResponse;
